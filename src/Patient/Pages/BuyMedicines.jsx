    ...
    <>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          ...
          <div className="flex flex-col gap-5">
            ...
            <div className="bg-white shadow-lg rounded-xl p-6 hover:shadow-2xl transition">
              ...
              />
              <h3 className="text-xl font-semibold text-center mt-4 text-blue-500">
      ...
      <div className="px-5 md:px-20 py-10 relative">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          {productsData.map((product) => (
            ...
            >
              ...
              <p className="text-center text-blue-600 font-bold text-lg mt-2">
                ₹ {product.price}
              </p>
        ...
        <button
          ...
          className="fixed bottom-5 right-5 bg-blue-600 text-white px-5 py-3 rounded-full shadow-lg hover:bg-blue-700"
        >
          Cart ({cart.length})
        </button>
